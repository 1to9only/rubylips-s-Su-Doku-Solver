...
public class LeastCandidatesHybrid extends StrategyBase implements IStrategy {
     ...
     * When checkInvulnerable is selected, the moves generated by standard
     * LeastCandidatesHybrid will be filtered using the Invulnerable state grid.
     */    
    
    public LeastCandidatesHybrid( boolean randomize , boolean checkInvulnerable ){
        super( randomize );
	...
	public boolean updateState(int x , int y , int value , boolean writeState ) {
		...
		return lcn.updateState( x , y , value , writeState ) && lcc.updateState( x , y , value , writeState );
	}
